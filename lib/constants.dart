...
class MyCustomarColors {
  ...
  static const Color pinchOfPepper = Color.fromRGBO(10, 22, 14, 1);
...
class CustomImage {
  static const AssetImage link = AssetImage('assets/images/link.png');
}

class MyCustomPadding {
  static const paddingAllEight = EdgeInsets.all(8.0);
}
