...
class _DropDownButtonState extends State<DropDownButton> {
  ...
  TextStyle dropbuttontextstyle() {
    return const TextStyle(
        color: DropDownButtonColors.zhebZhuBaiPearl, fontSize: 14);
  }
  ...
  DropdownMenuItem<String> buildMenuItem(String item) => DropdownMenuItem(
        ...
        child: Text(
          ...
          style: const TextStyle(
              color: DropDownButtonColors.midasFingerGold, fontSize: 14),
        ),
      );
}
...
class DropButtonIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Icon(Icons.keyboard_arrow_down,
        color: DropDownButtonColors.midasFingerGold);
  }
}
